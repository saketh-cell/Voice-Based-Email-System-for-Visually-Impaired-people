...
def UserLogin(request):
    if request.method == 'GET':
        ...
        while (flag):
            ...
            if uname != 'no':
                texttospeech("You meant " + uname + " say correct to confirm or wrong to enter again", file + index)
                index = index + str(1)
                say = speechtotext(5)
                print("===================="+say)
                if say == 'correct' or say == 'Correct':
                    flag = False
            else:
        ...
        while (flag):
            ...
            if password != 'no':
                texttospeech("You meant " + password + " say correct to confirm or wrong to enter again", file + index)
                index = index + str(1)
                say = speechtotext(3)
                if say == 'correct' or say == 'Correct':
                    flag = False
...
def ComposeMails(request):
    if request.method == 'GET':
        ...
        while (flag):
            ...
            if receiver != 'no':
                texttospeech("You meant " + receiver + " as receiver say correct to confirm or wrong to enter again", file + index)
                index = index + str(1)
                say = speechtotext(3)
                if say == 'correct' or say == 'Correct':
        ...
        while (flag):
            ...
            if subject != 'no':
                texttospeech("You meant " + subject + " as subject say correct to confirm or wrong to enter again", file + index)
                index = index + str(1)
                say = speechtotext(3)
                if say == 'correct' or say == 'Correct':
                    flag = False
        ...
        while (flag):
            ...
            if message != 'no':
                texttospeech("You meant " + message + " as message say correct to confirm or wrong to enter again", file + index)
                index = index + str(1)
                say = speechtotext(3)
                if say == 'correct' or say == 'Correct':
                    flag = False
